function [sqeracti,sqervale,sqerdis,coefActi,coefVale] =testsvmparameter1(actipara,valepara,featurenum)
...
resultacti=Train2DEmotionIEMOCAPDirectData(arousepath,FEATUREAROUSALINDEX(1:featurenum),actipara,80,testingIndex);
resultvale=Train2DEmotionIEMOCAPDirectData(valencepath,FEATUREVALENCEINDEX(1:featurenum),valepara,80,testingIndex);

function [sqeracti,sqervale,sqerdis,coefActi,coefVale] =testsvmparameter1v2(actipara,valepara,actiparac,valeparac,featurenum,trainIndex) % k-folders cross validation

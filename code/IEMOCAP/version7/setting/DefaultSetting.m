...
setting.recordingName = '../data/Ses01F_impro01.wav'
setting.featureFileName = '../tempfile/feature/testFeature.csv'
setting.timeStampUtterance = '../tempfile/timestamp/timeStampUtterance.csv'
setting.timeStampSegment = '../tempfile/timestamp/timeStampSeg.csv'
...
setting.sampleAnimation = '../result/EmotionAnimation.mp4'
setting.openSMILEPath = '../lib/openSMILE'
setting.modelPath = '../tempfile/model/model.mat'
setting.deviceRecording = '../data/devicerecording.wav'
